...
const MNReportComponent = () => {
    ...
    var curentapitinh = "/vnrain/Mucnuoc?luuvuc=" + getNameProvince(name_luuvuc) + "";
    var apireport = "/vnrain/Mucnuoc/processWaterLevelReport";
    var getapireport = "/vnrain/Mucnuoc/report_data?luuvuc=" + getNameProvince(name_luuvuc) + "";
    ...
    const fetchDatareport = async () => {
        const response = await fetch(getapireport + "&mathongso=DOMUCNUOC");
        const data = await response.json();
    ...
    const handleSubmit = async () => {
        const data = {
            luu_vuc : getNameProvince(name_luuvuc),
            name_file: "",
            file_ref: "",
...
export default MNReportComponent;