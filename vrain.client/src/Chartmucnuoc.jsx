...
const Chartmucnuoc = ({ dataChart, chartHeight }) => {
    ...
    const exportChartToExcel = (dataChart, dimensions, stationNames) => {
        ...
        XLSX.writeFile(workbook, "Dữ liệu trạm đo mực nước " + stationNames + ' chart_data_' + new Date().getTime() + '.xlsx');
    };
    useEffect(() => {
        ...
        if (dataChart.length > 0) {
            ...
            const dimensions = ['timepoint', ...stationNames];
            const series = [];
